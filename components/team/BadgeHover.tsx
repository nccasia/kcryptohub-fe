...
const BadgeHover = ({ label }: BadgeHoverProps) => {
  return (
    <div className="hidden z-[1] absolute items-center justify-center w-[100px] px-2 rounded-lg bg-white border-2 border-[#848ABD] py-2 shadow-sm group-hover:inline-flex right-1/2 bottom-[calc(100%+12px)] translate-x-1/2">
