  ...
  return (
    <section ref={skillDistributionRef} className="py-5">
      ...
      {teamProfile.skillDistribution?.length > 0 &&
        teamProfile.skillDistribution
          .slice(0, isReadMore ? teamProfile.skillDistribution?.length : 4)
          .map((item) => (
                      ...
                      +skillDistributionValue.quantity > 0 && (
                        <div
                          ...
                          style={{
                            ...
                            backgroundColor:
                              IColors[
                                index % (Object.keys(IColors).length / 2)
                              ],
                          }}
                        >
      ...
      {teamProfile.skillDistribution?.length > 4 && (
        <span
          className="items-center flex justify-center text-[#606060] text-ellipsis overflow-hidden text-sm 3xl:text-lg text-[#606060] hover:underline tracking-widest cursor-pointer "
          onClick={() => {
            setIsReadMore((cur) => !cur);
          }}
        >
