            ...
            <div className="md:flex w-full">
                <div className="md:flex-[50%] md:mr-5">
                    <p className="text-sm text-gray-600 py-5">
                        Give buyers a sense of how you spend your time. You must
                        add at least one (1) Service Line to your Company
                        Profile.
                    </p>
                    <div className="py-2">
                    ...
                    <h2 className="text-base py-2 text-gray-600">
                        Below is a full list of all the Service Lines available
                        on Clutch.
                    </h2>
